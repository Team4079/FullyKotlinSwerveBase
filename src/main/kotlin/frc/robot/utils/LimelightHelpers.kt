...
import frc.robot.utils.LimelightHelpers.LimelightTargetRetro
...
class LimelightHelpers {
  class LimelightTargetRetro {
    @JsonProperty("t6c_ts") private val cameraPose_TargetSpace: DoubleArray

    @JsonProperty("t6r_fs") private val robotPose_FieldSpace: DoubleArray

    @JsonProperty("t6r_ts") private val robotPose_TargetSpace: DoubleArray

    @JsonProperty("t6t_cs") private val targetPose_CameraSpace: DoubleArray

    @JsonProperty("t6t_rs") private val targetPose_RobotSpace: DoubleArray
    ...
    fun getCameraPose_TargetSpace2D(): Pose2d {
      return toPose2D(cameraPose_TargetSpace)
    }

    fun getRobotPose_FieldSpace2D(): Pose2d {
      return toPose2D(robotPose_FieldSpace)
    }

    fun getRobotPose_TargetSpace2D(): Pose2d {
      return toPose2D(robotPose_TargetSpace)
    }

    fun getTargetPose_CameraSpace2D(): Pose2d {
      return toPose2D(targetPose_CameraSpace)
    }

    fun getTargetPose_RobotSpace2D(): Pose2d {
      return toPose2D(targetPose_RobotSpace)
    }

    @JsonProperty("ta") var ta: Double = 0.0

    @JsonProperty("tx") var tx: Double = 0.0

    @JsonProperty("txp") var tx_pixels: Double = 0.0

    @JsonProperty("ty") var ty: Double = 0.0

    @JsonProperty("typ") var ty_pixels: Double = 0.0

    @JsonProperty("ts") var ts: Double = 0.0
  ...
  class LimelightTarget_Fiducial {
    @JsonProperty("fID") var fiducialID: Double = 0.0

    @JsonProperty("fam") var fiducialFamily: String? = null
  ...
  class LimelightTarget_Classifier {
    ...
    @JsonProperty("classID") var classID: Double = 0.0

    @JsonProperty("conf") var confidence: Double = 0.0

    @JsonProperty("zone") var zone: Double = 0.0
  ...
  class Results {
    @JsonProperty("pID") var pipelineID: Double = 0.0

    @JsonProperty("tl") var latency_pipeline: Double = 0.0

    @JsonProperty("cl") var latency_capture: Double = 0.0

    var latency_jsonParse: Double = 0.0

    @JsonProperty("ts") var timestamp_LIMELIGHT_publish: Double = 0.0

    @JsonProperty("ts_rio") var timestamp_RIOFPGA_capture: Double = 0.0

    @JsonProperty("v") @JsonFormat(shape = JsonFormat.Shape.NUMBER) var valid: Boolean = false

    @JsonProperty("botpose") var botpose: DoubleArray

    @JsonProperty("botpose_wpired") var botpose_wpired: DoubleArray

    @JsonProperty("botpose_wpiblue") var botpose_wpiblue: DoubleArray

    @JsonProperty("t6c_rs") var camerapose_robotspace: DoubleArray?

    fun getBotPose3d(): Pose3d {
      return toPose3D(botpose)
    }

    fun getBotPose3d_wpiRed(): Pose3d {
      return toPose3D(botpose_wpired)
    }

    fun getBotPose3d_wpiBlue(): Pose3d {
      return toPose3D(botpose_wpiblue)
    }

    fun getBotPose2d(): Pose2d {
      return toPose2D(botpose)
    }

    fun getBotPose2d_wpiRed(): Pose2d {
      return toPose2D(botpose_wpired)
    }

    fun getBotPose2d_wpiBlue(): Pose2d {
      return toPose2D(botpose_wpiblue)
    }

    @JsonProperty("Retro") var targets_Retro: Array<LimelightTargetRetro?>?

    @JsonProperty("Fiducial") var targets_Fiducials: Array<LimelightTarget_Fiducial?>?

    @JsonProperty("Classifier") var targets_Classifier: Array<LimelightTarget_Classifier?>?

    @JsonProperty("Detector") var targets_Detector: Array<LimelightTarget_Detector?>?

    @JsonProperty("Barcode") var targets_Barcode: Array<LimelightTarget_Barcode?>?
    ...
    init {
      ...
      targets_Retro = arrayOfNulls<LimelightTargetRetro>(0)
  ...
  class LimelightResults {
    @JsonProperty("Results") var targetingResults: Results
  ...
  fun getXField(): Double {
    val pose = getBotPose2d("limelight")
    return pose.getX()
  }

  fun getYField(): Double {
    val pose = getBotPose2d("limelight")
    return pose.getY()
  }
  ...
  companion object {
    ...
    fun takeSnapshot(tableName: String?, snapshotName: String?): CompletableFuture<Boolean?> {
      return CompletableFuture.supplyAsync<Boolean?>(
        Supplier { SYNCH_TAKESNAPSHOT(tableName, snapshotName) }
      )
    }
    ...
    fun getLatestResults(limelightName: String?): LimelightResults {
      ...
      try {
        results =
          mapper!!.readValue<LimelightResults>(
